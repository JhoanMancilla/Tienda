...
ALTER TABLE `curso_horario` ADD CONSTRAINT `curso_horario-curso` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `profesor_curso` ADD CONSTRAINT `profesor_curso-curso` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `alumno_curso` ADD CONSTRAINT `alumno_curso-curso` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `persona` ADD CONSTRAINT `persona-tipo_persona` FOREIGN KEY (`tipo_persona`) REFERENCES `tipo_persona` (`nombre`) ON DELETE RESTRICT ON UPDATE CASCADE;
