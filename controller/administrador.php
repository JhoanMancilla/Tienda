...
class Administrador extends Controller
{
    ...
    public  function __construct0(){
        ...
        if (isset($_SESSION['administrador'])) {
        parent::__construct();
        $this->view->render("administrador/administrador");
        }else{
            header("Location: /");
    ...
    public function agregarProfesores(){
        $data=$this->data["data"];
        echo $this->model->agregarProfesores($data);
    }
    ...
    public function listarProfesor(){
        $data=$this->data["data"];
        echo $this->model->listarProfesor($data);
    }

    public function actualizarProfesor(){
        $data=$this->data["data"];
        echo $this->model->actualizarProfesor($data);
    }

    public function agregarProfesor(){
        $data=$this->data["data"];
        echo $this->model->agregarProfesor($data);
    }
}
